...
<form action="<?php echo e(url('update-artical')); ?>" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
	 <label>Title</label>	
		<input type="text" class="form-control" value="<?php if($artical->title): ?> <?php echo e($artical->title); ?> <?php endif; ?>" name="title" placeholder="Enter title">
	</div>
	<div class="form-group">
		 <label>Body</label>	
		<textarea class="form-control" name="body"  ><?php if($artical->title): ?> <?php echo e($artical->body); ?> <?php endif; ?></textarea>
	</div>
	<div class="form-group">
	...
	<div class="row">
		<div class="col-md-6">
			<?php if($artical->image): ?>
			<img src="<?php echo e(asset('storage/'.$artical->image)); ?>" width="200px" height="200px" />
		
			<?php else: ?>
		<img src="<?php echo e(asset('storage/artical/artical.jpeg')); ?>" width="200px" height="200px" />
			<?php endif; ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Artical/resources/views/artical/edit.blade.php ENDPATH**/ ?>